...
export async function startPortForward(request: PortForwardRequest): Promise<PortForwardResponse> {
  try {
    const response = await fetch('/operator/api/v1/portforward/start', {
      method: 'POST',
      headers: {
...
export async function stopPortForward(request: StopPortForwardRequest): Promise<void> {
  try {
    const response = await fetch('/operator/api/v1/portforward/stop', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export async function getPortForwards(clusterName: string): Promise<PortForward[]> {
  try {
    const response = await fetch(`/operator/api/v1/portforward?cluster=${encodeURIComponent(clusterName)}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export async function getPortForwardById(clusterName: string, id: string): Promise<PortForward> {
  try {
    const response = await fetch(`/operator/api/v1/portforward/${id}?cluster=${encodeURIComponent(clusterName)}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export async function portForwardService(
  ...
  try {
    ...
    const response = await fetch(`/operator/api/v1/services/${namespace}/${serviceName}/portforward`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
