...
export async function listHelmRepositories(clusterName: string): Promise<HelmRepository[]> {
  try {
    const response = await fetch(`/operator/cluster/${clusterName}/helm/repositories`, {
      method: 'GET',
      headers: {
...
export async function removeHelmRepository(
  ...
  try {
    const response = await fetch(`/operator/cluster/${clusterName}/helm/repositories?name=${encodeURIComponent(name)}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
...
export async function listHelmCharts(
  ...
  try {
    let url = `/operator/cluster/${clusterName}/helm/charts`;
    if (filter) {
...
export async function listHelmReleases(
  ...
  try {
    let url = `/operator/cluster/${clusterName}/helm/releases?`;
...
export async function getHelmRelease(
  ...
  try {
    const url = `/operator/cluster/${clusterName}/helm/release?name=${encodeURIComponent(releaseName)}&namespace=${encodeURIComponent(namespace)}`;
...
export async function getHelmReleaseHistory(
  ...
  try {
    const url = `/operator/cluster/${clusterName}/helm/release/history?name=${encodeURIComponent(releaseName)}&namespace=${encodeURIComponent(namespace)}`;
...
export async function installHelmRelease(
  ...
  try {
    const url = `/operator/cluster/${clusterName}/helm/release/install`;
...
export async function upgradeHelmRelease(
  ...
  try {
    const url = `/operator/cluster/${clusterName}/helm/release/upgrade`;
...
export async function rollbackHelmRelease(
  ...
  try {
    const url = `/operator/cluster/${clusterName}/helm/release/rollback`;
...
export async function getHelmActionStatus(
  ...
  try {
    let url = `/operator/cluster/${clusterName}/helm/release/status?name=${encodeURIComponent(releaseName)}&action=${encodeURIComponent(action)}`;
...
export async function getChartVersions(
  ...
  try {
    const url = `/operator/proxy/helm-versions?repo=${encodeURIComponent(repoName)}&chart=${encodeURIComponent(chartName)}`;
...
export async function getChartDefaultValues(
  ...
  try {
    const url = `/operator/proxy/helm-values?package=${encodeURIComponent(packageId)}&version=${encodeURIComponent(version)}`;
