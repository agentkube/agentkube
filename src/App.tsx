...
import { TerminalProvider } from "./contexts/useTerminal";
import { CodeBlockProvider } from "./contexts/useCodeBlock";
                        ...
                        <TerminalProvider>
                          <DrawerProvider>
                            <NamespaceProvider>
                              ...
                              <div className="h-screen bg-background overflow-clip">
                                <Menu />
