...
import { TrivyNotInstalledAuditReport } from "@/components/custom";
...
**Namespace:** ${report.metadata.labels?.['trivy-operator.resource.namespace'] || report.metadata.namespace || 'N/A'}`;
  ...
  if (!isTrivyInstalled) {
    return (
      <TrivyNotInstalledAuditReport
        title="Audit Report"
        subtitle="Trivy Operator is required to generate Audit Reports that identify misconfigurations in your Kubernetes resources. Install it to audit your cluster’s configuration and improve its security posture."
