...
const Events: React.FC = () => {
  ...
  const defaultColumnConfig: ColumnConfig[] = [
    ...
    { key: 'count', label: 'Count', visible: true, canToggle: true },
    { key: 'source', label: 'Source', visible: true, canToggle: true },
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="flex items-center gap-2 dark:bg-transparent dark:text-gray-400 border-gray-400 dark:border-gray-800"
              >
                <Filter className="h-4 w-4" /> Column
              </Button>
            </div>
          </div>
        </div>
