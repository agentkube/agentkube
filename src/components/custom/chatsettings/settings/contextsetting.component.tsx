      ...
      <div>
        ...
        <div className="bg-card dark:bg-card rounded-lg p-4">
          <div className="flex items-start space-x-3 mb-4">
            ...
            <div>
              <p className="text-sm text-foreground/60 dark:text-foreground/80 mb-2">
              ...
              <div className="text-xs text-foreground/60 dark:text-foreground/60">
            ...
            <div className="mb-4">
              <div className="border border-gray-300 dark:border-gray-600/30 rounded-lg">
                <div className="flex items-start justify-between p-3">
                  <div className="flex items-center">
                    <div className='p-1 rounded-md w-fit mr-2'>
                      <FileX className="w-4 h-4 text-foreground/60 dark:text-foreground/80" />
                    </div>
                ...
                <div className="px-3 pb-3 max-h-40 overflow-y-auto">
                  <pre className="text-xs text-foreground/60 dark:text-foreground/80 whitespace-pre-wrap">
                    {savedIgnoreRules}
                  </pre>
                </div>
              </div>
          ...
          {showIgnoreForm ? (
            ...
            <Button
              variant="outline"
              size="sm"
              className="text-foreground/60 dark:text-gray-400"
          ...
          {savedDocs && !showDocsForm && (
            <div className="mb-4">
              <div className="border border-gray-300 dark:border-gray-600/30 rounded-lg">
                ...
                <div className="px-3 pb-3 max-h-40 overflow-y-auto">
                  <pre className="text-xs text-foreground/60 dark:text-gray-400 whitespace-pre-wrap">
                    {savedDocs}
                  </pre>
                </div>
              </div>
