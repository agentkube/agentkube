...
import { Cpu, MemoryStick, Activity, Network, Search, RefreshCw } from 'lucide-react';
    ...
    <div className="space-y-2 pb-10">
      ...
      <div className="grid grid-cols-1 gap-2">
        ...
        <div className="bg-gray-50 min-h-64 dark:bg-gray-800/20 rounded-lg ">
          <div className="text-xs flex dark:bg-gray-800/40  items-center gap-2 mb-2 p-1.5 rounded-t-md">
                      ...
                      {filteredPods.map((pod) => (
                        <tr
                          ...
                          className={`border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors ${
                            selectedPod === pod.name && selectedNamespace === pod.namespace
