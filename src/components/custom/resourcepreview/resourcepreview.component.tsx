...
const ResourcePreview: React.FC<ResourcePreviewProps> = ({ resource, onClose }) => {
  ...
  return (
    <div 
      ref={previewRef}
      className="absolute left-0 bottom-full mb-1 w-full rounded-xl shadow-lg bg-gray-100/60 dark:bg-[#0B0D13] backdrop-blur-sm border border-gray-300 dark:border-gray-800/50 z-50"
    >
      <div className="flex items-center justify-between p-2 border-b bg-gray-300/30 dark:bg-gray-600/20 border-gray-200 dark:border-gray-500/30">
        <div className="flex items-center flex-wrap text-sm font-medium space-x-2"> 
          <img src={KUBERNETES} className='h-5 w-5' alt="Kubernetes logo" />
          <span>
      ...
      <div className="bg-gray-800 dark:bg-transparent relative group max-h-80 overflow-auto
